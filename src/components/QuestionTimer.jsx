...
//every 100 miliseconds setInterval will run which in turn re-create setTimeOut 
//as comp will re-render =>and quickly, we will have multiple setTimeOuts. 
